...
const OverallRanking = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <ImageBackground style={{flexGrow: 1, position: 'relative'}} source={require('./../source/images/overall-ranking-gradient.png')}>
          <Image style={{position: 'absolute', width: '100%', top: '15%'}} source={require('./../source/images/bg-purple-circle.png')} />
                    ...
                    <View style={[styles.cardCol, { position: 'relative', top: 170 }]}>
                      <View style={[styles.cardBox]}>
                          ...
                          <View style={{alignItems: 'center'}}>
                            ...
                            <Text style={styles.rankpointText}>Mystery Perosn</Text>
                          </View>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={{width: '60%'}}>
                    <View style={{flexDirection: 'row', gap: 10}}>
                      ...
                      <View>
                        <Text style={[styles.tableText, {marginBottom: 10}]}>
                          Gojo Satoru
                        </Text>
                  ...
                  <View style={{width: '25%'}}>
                    <View style={{flexDirection: 'row', gap: 10}}>
                      ...
                      <Text style={styles.tableText}>254654</Text>
                    </View>
                  </View>
                </View>
                <View style={styles.tableRow}>
